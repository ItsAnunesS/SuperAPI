 ...
 * @subpackage Api_Anuness_Dev/admin
 */
...
class Api_Anuness_Dev_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/api-anuness-dev-admin.css', array(), $this->version, 'all' );
