...
class Api_Anuness_Dev_Chats_Post_Type extends Api_Anuness_Dev_Custom_Post_Type
{
    ...
    protected function get_post_type_args()
    {
        $args = array(
            'labels'      => array(
                'name'          => __('Chats', 'api-anuness-dev'),
                'singular_name' => __('Chat', 'api-anuness-dev'),
            ),
            'public'      => true,
            'has_archive' => false,
            'rewrite'     => array(
